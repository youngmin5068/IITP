...
class LKA_SwinUNETR(nn.Module):
    ...
    def forward(self, x_in):
        ...
        dec3 = self.decoder5(dec4, self.lka_hidden(hidden_states_out[3]))
        dec2 = self.decoder4(dec3, self.lka3(enc3))
        dec1 = self.decoder3(dec2, self.lka2(enc2))
        dec0 = self.decoder2(dec1, self.lka1(enc1))
        out = self.decoder1(dec0, self.lka0(enc0))
        logits = self.out(out)
        return logits
